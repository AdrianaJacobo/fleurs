...
export const Verano = () => {
  ...
  const [detalleModalShow, setdetalleModalShow] = useState(false);
  return (
    <div className="main">
      <div className="aver">
        <Navbar
        ...
        <div className="banner-imageverano w-100 vh-100 d-flex justify-content-center align-items-center">
          <div className="container content text-center text-white">
            ...
            <h2 className="pb-1">Verano</h2>

            <p className=" pb-2">
              El verano es una temporada de resplandor, cuando la naturaleza se
              viste con sus colores más vibrantes y el sol brilla en su máximo
              esplendor.
            </p>
        ...
        <div className="container" id="catalogoP">
          ...
          <div className="col-md-3 col-sm-auto">
              <Card style={{ width: "16rem" }}>
                ...
                <Card.Body className="text-center">
                  <Card.Text className="txtC">Brillo Estival</Card.Text>
                  <div>
                  <Button
                    variant="outline-dark px-5"
                    style={{ borderRadius: "0px"}}
                    href="#catalogoP"
                    onClick={() => setdetalleModalShow(true)}
                  >
                    Ordenar
                  </Button>
                  </div>
          ...
          <div className="col-md-3 col-sm-auto">
            ...
            <Detalle
                    show={detalleModalShow}
                    onHide={() => setdetalleModalShow(false)}
                  />
          </div>
