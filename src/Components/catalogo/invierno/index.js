  ...
  return (
    <div className="main">
      <div className="aver">
        ...
        <div className="banner-image-invierno w-100 vh-100 d-flex justify-content-center align-items-center">
          <div className="container content text-center text-white">
            ...
            <h2 className="pb-1">Invierno</h2>

            <p className=" pb-2">
              El invierno es un período de serenidad, cuando la tierra se cubre
              de un manto de nieve y la quietud del frío nos invita a la
          ...
          <div className="row d-flex pb-5 mt-5 justify-content-center">
            <div className="col-md-3 col-sm-auto">
              <Card style={{ width: "16rem" }}>
                ...
                <Card.Body>
                  <Card.Text className="txtC">Diamantes de Invierno</Card.Text>
                  <Button
