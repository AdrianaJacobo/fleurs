  ...
  return (
    <div className="main">
      <div className="aver">
        ...
        <div className="banner-image-otonio w-100 vh-100 d-flex justify-content-center align-items-center">
          <div className="container content text-center text-white">
            ...
            <h2 className="pb-1">Otoño</h2>

            <p className=" pb-2">
              El otoño es una época de transformación, cuando las hojas se tiñen
              de tonos cálidos y la naturaleza se prepara para el descanso
              invernal.
            </p>
          ...
          <div className="row d-flex pb-5 mt-5 justify-content-center">
            <div className="col-md-3 col-sm-auto">
              <Card style={{ width: "16rem" }}>
                ...
                <Card.Body>
                  <Card.Text className="txtC">Armonia Otoñal</Card.Text>
                  <Button
